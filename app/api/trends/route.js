  ...
  try {
    ...
    const res = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        system: "你是马来西亚华人社交媒体市场专家。只返回JSON。",
        messages: [{ role: "user", content: `分析「${niche}」在马来西亚华人市场的当前内容趋势。语言：${language || "中文"}

返回JSON：
{
  "trending_topics": [{"topic":"话题","why_trending":"原因","virality_score":85,"platforms":["IG"],"sample_hook":"示例Hook"}],
  "avoid_topics": ["不要碰的话题"],
  "weekly_insights": "本周洞察",
  "action_items": ["今天就能做的行动"]
}` }],
      }),
    });
    ...
    catch { trends = { trending_topics: [], weekly_insights: text, action_items: [] }; }
